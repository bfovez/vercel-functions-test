import { HttpApi, HttpApiBuilder, HttpApiEndpoint, HttpApiGroup, HttpApiScalar, HttpLayerRouter, HttpServer } from "@effect/platform";
import { Effect, Layer, Schema } from "effect";
const Group = HttpApiGroup.make("group").add(HttpApiEndpoint.get("get", "/").addSuccess(Schema.String));
const Api = HttpApi.make("myApi").add(Group).prefix("/api");
const GroupLayer = HttpApiBuilder.group(Api, "group", (handlers) => handlers.handle("get", () => Effect.succeed("Hello, world!")));
